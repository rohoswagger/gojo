...
enum AltTabModifierKey: String, CaseIterable, Identifiable, Defaults.Serializable {
    ...
    /// SF Symbol / glyph shown in settings.
    var symbol: String {
        switch self {
        case .command: return "⌘"
        case .option: return "⌥"
...
extension Defaults.Keys {
    ...
    static let altTabModifier = Key<AltTabModifierKey>("altTabModifier", default: .command)
    static let altTabReverseWithShift = Key<Bool>("altTabReverseWithShift", default: true)
    static let altTabCurrentDisplayOnly = Key<Bool>("altTabCurrentDisplayOnly", default: true)
    static let altTabShowTitles = Key<Bool>("altTabShowTitles", default: true)
