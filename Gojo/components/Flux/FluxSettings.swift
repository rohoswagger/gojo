...
struct FluxSettings: View {
    ...
    @Default(.fluxTransitionMinutes) var transitionMinutes
    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Picker("Transition speed", selection: $transitionMinutes) {
                    Text("Instant (5 min)").tag(5)
                    Text("Fast (15 min)").tag(15)
                    Text("Normal (30 min)").tag(30)
                    Text("Gradual (60 min)").tag(60)
                    Text("Slow (90 min)").tag(90)
                }
                Text("The screen gradually warms from the evening temperature to the bedtime temperature as bedtime approaches, then holds it until sunrise. Transition speed controls how quickly the shift happens at sunrise and sunset.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            } header: {
                Text("Schedule")
