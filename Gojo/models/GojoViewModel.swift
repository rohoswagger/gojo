...
class GojoViewModel: NSObject, ObservableObject {
    @ObservedObject var coordinator = GojoViewCoordinator.shared
    @ObservedObject var detector = FullscreenMediaDetector.shared

    let animationLibrary: GojoAnimations = .init()
    ...
    func close() {
        ...
        if Defaults[.shelfEnabled] && !ShelfStateViewModel.shared.isEmpty && Defaults[.openShelfByDefault] {
